        ...
        - - Warianty analizy: bezinwestycyjny (obowiązkowy) + inwestycyjny/e (nazwy i opis)
          - - Polityka rachunkowości beneficjenta (dokument lub kluczowe ustalenia)
            - - Granulacja modelu: roczna / kwartalna / miesięczna
              ...
              - **Wywoływany subagent:** `identyfikacja-dane-wejsciowe`
              ...
              - **Rozgraniczenie z ETAP 0:** parametry zatwierdzone w PK-0 nie pozostają wyłącznie w dialogu inicjalizacyjnym — `identyfikacja-dane-wejsciowe` zapisuje je do zakładki „Dane wejściowe i założenia" jako trwałe, jedno źródło prawdy, do którego wszystkie kolejne subagenty odwołują się formułami Excel. Subagent ten nie modyfikuje żadnej innej zakładki.
            ...
            - **Wywoływany subagent:** `klasyfikacja-budzet`
            ...
            - **Wywoływany subagent:** `majatek-i-amortyzacja`
           
            - **Przekazujesz:** dane z `klasyfikacja-budzet` (wstępna klasyfikacja KŚT/WNiP), stawki amortyzacji z zakładki założeń, daty przyjęcia do użytkowania wskazane przez Analityka.
            ...
            - **Wywoływany subagent:** `przychody-i-koszty`
            ...
            - **Wywoływany subagent:** `wskazniki-finansowe`
            ...
            - **Wywoływany subagent:** `analiza-ekonomiczna`
            ...
            - **Wywoływany subagent:** `wrazliwosc-i-ryzyko`
                ...
                - - Kluczowe wnioski z analizy wrażliwości (TOP 3 zmienne krytyczne)
                  - - Wynik oceny trwałości finansowej
                    - - Zestawienie ryzyk wysokiego profilu
                      ...
                      - |----------|------|----------------|
                      - | `identyfikacja-dane-wejsciowe` | 0a | Dane wejściowe i założenia |
                      - | `klasyfikacja-budzet` | 1a | Budżet |
                      - | `majatek-i-amortyzacja` | 1b | Majątek i amortyzacja |
                      - | `przychody-i-koszty` | 1c | Przychody i koszty |
                      - | `wskazniki-finansowe` | 1d | Wskaźniki finansowe |
                      - | `analiza-ekonomiczna` | 2 | Analiza ekonomiczna |
                      - | `wrazliwosc-i-ryzyko` | 3 | Wrażliwość i ryzyko |
                      - | `trwalosc` | 4 | Trwałość finansowa |
